        ...
        <section class="container-fluid">
            ...
            <div class="row">   
                <div class="col-md-4 col-sm-10 col-10 container">
                    <img class="image" src="views/images/norway.jpg" class="img-thumbnail img-responsive margin" width="100%" alt="Norwegian landscape"/>
                    <div class="middle">
                    <div class="text">10 Instagrammable places in Norway</div>   
                    </div>
                </div>
                <div class="col-md-4 col-sm-10 col-10 container">
                    <img class="image" src="views/images/sanfrancisco.jpg" class="img-thumbnail img-responsive margin" width="100%" alt="Street in Sanfrancisco"/>
                    <div class="middle">
                    <div class="text">Top 10 cheap eats in Sanfran</div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-10 col-10 container">
                    <img class="image" src="views/images/greece.jpg" class="img-thumbnail img-responsive margin" width="100%" alt="Greek beach">
                    <div class="middle">
