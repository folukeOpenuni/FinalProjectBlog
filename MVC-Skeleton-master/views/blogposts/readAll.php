...
<!--BLOG POST LISTINGS-->
        ...
        <a href='?controller=blogpost&action=read&BlogPostID=<?php echo $blogpost->BlogPostID; ?>'><img class="image" src="views/blogposts/<?php echo $blogpost->BlogPostID; ?>/<?php echo $blogpost->HeaderImage;?>" class="img-thumbnail img-responsive" width="100%">
        <div class="middle">
